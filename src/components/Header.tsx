...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-40 h-16 campus-glass border-b border-[#5B2BBE]/10 dark:border-[#5B2BBE]/25 transition-colors duration-300">
      <div className="max-w-6xl mx-auto h-full px-4 sm:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button 
            ...
            className="w-10 h-10 rounded-xl flex items-center justify-center text-[#5B2BBE] dark:text-[#C39BFF] hover:bg-[#5B2BBE]/10 dark:hover:bg-[#5B2BBE]/25 active:scale-95 transition-all cursor-pointer border border-[#5B2BBE]/15 dark:border-[#5B2BBE]/30 bg-white/70 dark:bg-[#1B1638]"
          >
            <span className="material-symbols-outlined text-[24px]">menu</span>
          </button>
          
          {activeTabTitle && (
            <div className="hidden sm:flex items-center gap-2 border-l border-[#5B2BBE]/15 dark:border-[#5B2BBE]/30 pl-3">
        ...
        <div className="flex items-center gap-2">
          <button 
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all border cursor-pointer active:scale-95 shadow-2xs bg-white/90 dark:bg-[#251F4A] text-[#22202A] dark:text-[#F2B632] border-[#5B2BBE]/15 dark:border-[#5B2BBE]/35 hover:bg-[#5B2BBE]/5 dark:hover:bg-[#322B60]"
          >
