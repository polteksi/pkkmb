...
export const AtributTab: React.FC = () => {
  ...
  return (
    <div className="tab-fade-in flex flex-col gap-6 pb-8">
      ...
      {/* Header Banner */}
      <div className="campus-card bg-white dark:bg-[#1B1638] p-6 sm:p-7 border border-[#5B2BBE]/12 dark:border-[#D63BBE]/20 shadow-xs flex flex-col gap-2 relative overflow-hidden">
        <div className="absolute top-4 right-6 opacity-20 pointer-events-none">
          <BrandDecoration type="starburst" size={28} color="#D63BBE" secondaryColor="#5B2BBE" />
        </div>
        <div className="flex items-center gap-2 text-[#D63BBE] dark:text-[#FF85EA] relative z-10">
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
          {PERLENGKAPAN_ITEMS.map((item, idx) => (
            <div
              key={item.id}
              className="campus-card bg-white dark:bg-[#1B1638] p-4 border border-[#5B2BBE]/10 dark:border-[#D63BBE]/20 flex items-start gap-3 shadow-xs transition-all hover:border-[#5B2BBE]/25 dark:hover:border-[#D63BBE]/35"
            >
              {/* Number circle */}
        ...
        <div className="flex items-center gap-4 px-1 flex-wrap">
          <div className="flex items-center gap-1.5">
            <span className="text-[9px] bg-[#F06C7D]/15 text-[#F06C7D] font-bold px-2 py-0.5 rounded-full border border-[#F06C7D]/30">Wajib</span>
            <span className="text-xs text-[#6B6874] dark:text-[#A39EB8] font-medium">Harus dibawa, akan diperiksa panitia</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="text-[9px] bg-[#2F9672]/10 text-[#2F9672] font-bold px-2 py-0.5 rounded-full border border-[#2F9672]/20">Anjuran</span>
      ...
      {/* Divider */}
      <div className="flex items-center gap-3">
        <div className="h-px flex-1 bg-gradient-to-r from-transparent to-[#5B2BBE]/20 dark:to-[#D63BBE]/20" />
        <span className="text-xs font-bold text-[#6B6874] dark:text-[#A39EB8] uppercase tracking-wider font-display shrink-0">
          Ketentuan Pakaian
        </span>
        <div className="h-px flex-1 bg-gradient-to-l from-transparent to-[#5B2BBE]/20 dark:to-[#D63BBE]/20" />
      </div>

      {/* ═══ POIN B: DRESSCODE PER HARI ═══════════════════════════════════ */}
      <section className="flex flex-col gap-4">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-xl bg-[#D63BBE] text-white flex items-center justify-center shrink-0 font-display font-black text-sm shadow-xs">
            B
          </div>
          <div>
            <h3 className="font-display font-bold text-base sm:text-lg text-[#22202A] dark:text-white leading-tight">
            ...
            <button
              ...
              className={`flex flex-col items-center px-3.5 py-2 rounded-xl border transition-all cursor-pointer shrink-0 ${
                activeDresscodeIdx === idx
                  ? 'bg-[#D63BBE] dark:bg-[#D63BBE] text-white border-[#D63BBE] dark:border-[#D63BBE] shadow-sm font-bold'
                  : 'bg-white dark:bg-[#1B1638] text-[#6B6874] dark:text-[#A39EB8] border-slate-200 dark:border-[#251F4A] hover:bg-[#FDE8FA]/60 dark:hover:bg-[#251F4A]/70 font-medium'
              }`}
            >
        ...
        <div className="campus-card bg-white dark:bg-[#1B1638] border border-[#D63BBE]/20 dark:border-[#D63BBE]/30 overflow-hidden shadow-xs">
          {/* Card Header */}
          <div className="bg-[#D63BBE]/8 dark:bg-[#D63BBE]/15 border-b border-[#D63BBE]/15 dark:border-[#D63BBE]/25 p-4 flex items-start justify-between gap-3">
            <div>
              <span className="text-[10px] font-bold text-[#D63BBE] dark:text-[#FF85EA] uppercase tracking-wider font-display">
            ...
            <span className="material-symbols-outlined text-[28px] text-[#D63BBE] dark:text-[#FF85EA] opacity-60">
              checkroom
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-[#5B2BBE]/8 dark:divide-[#251F4A]">
            ...
            <div className="p-4 flex flex-col gap-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-[#D63BBE]/10 dark:bg-[#D63BBE]/25 text-[#D63BBE] dark:text-[#FF85EA] flex items-center justify-center shrink-0">
                  <span className="material-symbols-outlined text-[16px]">woman</span>
                </div>
                <span className="font-display font-bold text-sm text-[#D63BBE] dark:text-[#FF85EA] uppercase tracking-wider">
                  Putri
                </span>
              </div>
              <div className="flex flex-col gap-2">
                {activeDresscode.putri.map((item, i) => (
                  <div key={i} className="flex items-start gap-2.5">
                    <span className="material-symbols-outlined text-[15px] text-[#D63BBE] dark:text-[#FF85EA] shrink-0 mt-0.5">
                      check_small
                    </span>
                    <p className="text-xs sm:text-sm text-[#22202A] dark:text-[#F3F2F8] font-medium leading-snug">
                      {item}
