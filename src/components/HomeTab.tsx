      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-stretch">
            <div className="campus-card campus-card-hover bg-white dark:bg-[#1B1638] p-5 border border-[#5B2BBE]/12 dark:border-[#5B2BBE]/25 flex flex-col justify-between gap-4 shadow-xs h-full min-w-0">
